        ...
        <div className="container-fluid">
            ...
            <div className="text-container">
                <div className="location-info d-flex align-items-center">
                    <FontAwesomeIcon className="location-icon" icon="fa-solid fa-location-dot"/>
                    <p className="location-country">{props.country}</p>
                    <p><a href="https://www.google.com/maps" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">View on google maps</a></p>
                </div>
                <h1 className="location-city">{props.destinationName}</h1>
                <div>
                    <p className="mb-0"><strong>{`${start} - ${end}`}</strong></p>
